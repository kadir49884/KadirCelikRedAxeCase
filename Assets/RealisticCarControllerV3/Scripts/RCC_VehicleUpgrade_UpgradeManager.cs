...
public class RCC_VehicleUpgrade_UpgradeManager : MonoBehaviour {
    ...
    private void Awake() {
        ...
        engine = GetComponentInChildren<RCC_VehicleUpgrade_Engine>();
        brake = GetComponentInChildren<RCC_VehicleUpgrade_Brake>();
        handling = GetComponentInChildren<RCC_VehicleUpgrade_Handling>();
